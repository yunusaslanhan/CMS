...
namespace CMSProject.Web
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			services.AddHttpClient<ILayoutApiClient, LayoutApiClient>();
			services.AddHttpClient<IPostApiClient, PostApiClient>();
			services.AddHttpClient<IMainPageApiClient, MainPageApiClient>();
